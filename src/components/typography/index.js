...
const { SelectControl, RadioControl, RangeControl, BaseControl } = wp.components;
...
import { ColorControlTest1 } from "../color-control/test/test";
...
export default class Typography extends Component {
  ...
  render() {
    ...
    const value =
      typeof fontOptions === "object" ? fontOptions : JSON.parse(fontOptions);

    const Divider = () => <hr style={{ marginBottom: "15px" }} />;
    ...
    const getWeightOptions = () => {
      ...
      if (fontOptions.length === 0) {
        return [
          ...
          {
            label: __("Extra Light (Ultra Light)", "gutenberg-extra"),
            value: 200
          },
          ...
          {
            label: __("Extra Bold (Ultra Bold)", "gutenberg-extra"),
            value: 800
          },
          { label: __("Black (Heavy)", "gutenberg-extra"), value: 900 },
          {
            label: __("Extra Black (Ultra Black)", "gutenberg-extra"),
            value: 950
          }
        ];
      }
    ...
    return (
      <div className={className}>
        <BaseControl className={"gx-settings-button"}>
                ...
                content: (
                  <Fragment>
                    ...
                    <SelectControl
                      ...
                      options={[
                        {
                          label: __("Default", "gutenberg-extra"),
                          value: "none"
                        },
                        {
                          label: __("Capitilize", "gutenberg-extra"),
                          value: "capitalize"
                        },
                        {
                          label: __("Uppercase", "gutenberg-extra"),
                          value: "uppercase"
                        },
                        {
                          label: __("Lowercase", "gutenberg-extra"),
                          value: "lowercase"
                        },
                        {
                          label: __("Full Width", "gutenberg-extra"),
                          value: "full-width"
                        },
                        {
                          label: __("Full Size Kana", "gutenberg-extra"),
                    ...
                    <SelectControl
                      ...
                      options={[
                        ...
                        {
                          label: __("Italic", "gutenberg-extra"),
                          value: "italic"
                        },
                        {
                          label: __("Oblique", "gutenberg-extra"),
                          value: "oblique"
                        },
                        {
                          label: __("Oblique (40 deg)"),
                          value: "oblique 40deg"
                        }
                      ]}
                    ...
                    <SelectControl
                      ...
                      options={[
                        ...
                        {
                          label: __("Overline", "gutenberg-extra"),
                          value: "overline"
                        },
                        {
                          label: __("Line Through", "gutenberg-extra"),
                          value: "line-through"
                        },
                        {
                          label: __("Underline", "gutenberg-extra"),
                          value: "underline"
                        },
                        {
                          label: __("Underline Overline", "gutenberg-extra"),
