...
describe('getOrganizedAttributes', () => {
	...
	it('Ensure getOrganizedAttributes work correctly with image copy-paste', () => {
		const object = {
			...
			'hover-border-radius-sync-general': 'all',
			'hover-border-radius-unit-general': 'px',
			'hover-border-width-top-general': 2,
			'hover-border-width-right-general': 2,
			'hover-border-width-bottom-general': 2,
			'hover-border-width-left-general': 2,
			'hover-border-width-sync-general': 'all',
			'hover-border-width-unit-general': 'px',
			...
			'image-border-radius-sync-general': 'all',
			'image-border-radius-unit-general': 'px',
			'image-border-radius-unit-general-hover': 'px',
			'image-border-width-top-general': 3,
			'image-border-width-right-general': 3,
			'image-border-width-bottom-general': 3,
			'image-border-width-left-general': 3,
			'image-border-width-sync-general': 'all',
			'image-border-width-unit-general': 'px',
			...
			'image-border-radius-top-left-general': 71,
			'image-border-radius-top-right-general': 71,
			'image-border-radius-bottom-right-general': 71,
			'image-border-radius-bottom-left-general': 71,
			'image-border-style-general-hover': 'dashed',
			'image-border-width-top-general-hover': 3,
			'image-border-width-right-general-hover': 3,
			'image-border-width-bottom-general-hover': 3,
			'image-border-width-left-general-hover': 3,
			'image-border-width-sync-general-hover': 'all',
			'image-border-width-unit-general-hover': 'px',
			'image-border-radius-top-left-general-hover': 71,
			'image-border-radius-top-right-general-hover': 71,
			'image-border-radius-bottom-right-general-hover': 71,
			'image-border-radius-bottom-left-general-hover': 71,
			'image-border-radius-sync-general-hover': 'all',
			'bs_po-general': 0.23,
			'bs_ho-general': 0,
			'bs_v-general': 30,
			'bs_blu-general': 50,
