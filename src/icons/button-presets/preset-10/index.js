...
const presetTen = () => (
	<SVG xmlns='http://www.w3.org/2000/svg'>
		<Path
			d='M5 0h25a4.95 4.95 0 015 5v25a4.95 4.95 0 01-5 5H5a4.95 4.95 0 01-5-5V5a4.95 4.95 0 015-5z'
			fill='#fff'
		/>
		<G fill='none' stroke='#163247' strokeWidth={1.5}>
			<Path d='M5 .8h25A4.23 4.23 0 0134.2 5v25a4.23 4.23 0 01-4.2 4.2H5A4.23 4.23 0 01.8 30V5A4.23 4.23 0 015 .8z' />
			<Path
