...
function addGXLayoutButton() {
    const wp_toolbar = document.querySelector(
    ...
    html += `<button id="gxAddLayoutButton" class="components-button components-icon-button" aria-label="${__(
        'Add Layout'
    )}">\
	</i><img src="/wp-content/plugins/maxi-blocks/img/GX-icon.png" /> ${__(
        'GX Library'
    )}</button>`;
    html += '</div>';
    ...
    document
        .getElementById('gxAddLayoutButton')
