...
describe('getOrganizedAttributes', () => {
	...
	it('Ensure getOrganizedAttributes work correctly with image copy-paste', () => {
		const object = {
			...
			'_p.sy-g': 'all',
			shortcutEffect: 0,
			'scroll-vertical.s-g': false,
			'scroll-vertical-preview.s-g': false,
			'scroll-vertical-easing-g': 'ease',
			'scroll-vertical-speed-g': 500,
			'scroll-vertical-delay-g': 0,
			'scroll-vertical-viewport.t-g': 'mid',
			'scroll-vertical.s-reverse-g': true,
			'scroll-vertical-offset-start-g': -400,
			'scroll-vertical-offset-mid-g': 0,
			'scroll-vertical-offset-end-g': 400,
			'scroll-horizontal.s-g': false,
			'scroll-horizontal-preview.s-g': false,
			'scroll-horizontal-easing-g': 'ease',
			'scroll-horizontal-speed-g': 500,
			'scroll-horizontal-delay-g': 0,
			'scroll-horizontal-viewport.t-g': 'mid',
			'scroll-horizontal.s-reverse-g': true,
			'scroll-horizontal-offset-start-g': -200,
			'scroll-horizontal-offset-mid-g': 0,
			'scroll-horizontal-offset-end-g': 200,
			'scroll-rotate.s-g': false,
			'scroll-rotate-preview.s-g': false,
			'scroll-rotate-easing-g': 'ease',
			'scroll-rotate-speed-g': 500,
			'scroll-rotate-delay-g': 0,
			'scroll-rotate-viewport.t-g': 'mid',
			'scroll-rotate.s-reverse-g': true,
			'scroll-rotate-rotate-start-g': 90,
			'scroll-rotate-rotate-mid-g': 0,
			'scroll-rotate-rotate-end-g': 0,
			'scroll-scale.s-g': false,
			'scroll-scale-preview.s-g': false,
			'scroll-scale-easing-g': 'ease',
			'scroll-scale-speed-g': 500,
			'scroll-scale-delay-g': 0,
			'scroll-scale-viewport.t-g': 'mid',
			'scroll-scale.s-reverse-g': true,
			'scroll-scale-scale-start-g': 70,
			'scroll-scale-scale-mid-g': 100,
			'scroll-scale-scale-end-g': 100,
			'scroll-fade.s-g': false,
			'scroll-fade-preview.s-g': false,
			'scroll-fade-easing-g': 'ease',
			'scroll-fade-speed-g': 500,
			'scroll-fade-delay-g': 0,
			'scroll-fade-viewport.t-g': 'mid',
			'scroll-fade.s-reverse-g': true,
			'scroll-fade-opacity-start-g': 0,
			'scroll-fade-opacity-mid-g': 100,
			'scroll-fade-opacity-end-g': 100,
			'scroll-blur.s-g': false,
			'scroll-blur-preview.s-g': false,
			'scroll-blur-easing-g': 'ease',
			'scroll-blur-speed-g': 500,
			'scroll-blur-delay-g': 0,
			'scroll-blur-viewport.t-g': 'mid',
			'scroll-blur.s-reverse-g': true,
			'scroll-blur-blur-start-g': 10,
			'scroll-blur-blur-mid-g': 0,
			'scroll-blur-blur-end-g': 0,
			'tr-translate-x.u-g': '%',
			'tr-translate-y.u-g': '%',
			'tr-origin-x.u-g': '%',
			'tr-origin-y.u-g': '%',
