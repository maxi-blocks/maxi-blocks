...
const motionFadeIn2 = () => {
    ...
    return (
      <SVG xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 72.75 65.25">
        ...
        <Path fill="none" stroke="#081219" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M35.3 38.12h3.57l-5-5m5 5h.29l-.25-3.57" data-name="Layer1 26 MEMBER 1 1 STROKES"/>
        <Path fill="none" stroke="#ff4a17" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M64.99 7.74l.14 7.29m-.14-7.29l-8.59 9m1.48-8.84l7.11-.11" data-name="Layer1 26 MEMBER 2 1 STROKES"/>
      </SVG>
    )
}
