...
const ColumnSize = props => {
    ...
    const value = !isObject(columnSize) ?
            ...
            content={(
                <Fragment>
                    <RangeControl
                        ...
                        value={getLastBreakpointValue(value, 'size', breakpoint)}
                        onChange={val => {
                            value[deviceType].size = val;
                        ...
                        step={.1}
                        allowReset
                        initialPosition={JSON.parse(getDefaultProp(clientId, 'columnSize'))[breakpoint].size}
                    />
                    <SelectControl
