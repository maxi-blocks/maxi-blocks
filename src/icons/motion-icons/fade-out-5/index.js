...
const motionFadeOut5 = () => {
  ...
  return (
    <SVG xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 72.75 65.25">
      ...
      <Path fill="none" stroke="#081219" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M35.14 22.7h3.57l-5-5m5 5h.28l-.25-3.57" data-name="Layer1 20 MEMBER 2 1 STROKES" />
      <Path fill="none" stroke="#ff4a17" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M63.53 48.07l.14-7.28m-.14 7.28l-8.59-8.94m1.49 8.84l7.11.1" data-name="Layer1 20 MEMBER 3 1 STROKES" />
    </SVG>
  )
}
