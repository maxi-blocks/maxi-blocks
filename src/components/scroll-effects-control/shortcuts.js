export const shortcut1 = {
	...
	'scroll-opacity-mid-fade-general': 50,
	'scroll-opacity-start-fade-general': 100,
	'scroll-speed-fade-general': 650,
	'scroll-status-fade-general': true,
	...
	'scroll-status-vertical-general': false,
	'scroll-status-horizontal-general': false,
	'scroll-status-scale-general': false,
	'scroll-status-blur-general': false,
};
export const shortcut2 = {
	// disable all
	'scroll-status-vertical-general': false,
	'scroll-status-horizontal-general': false,
	'scroll-status-rotate-general': false,
	'scroll-status-scale-general': false,
	'scroll-status-fade-general': false,
	'scroll-status-blur-general': false,
};
