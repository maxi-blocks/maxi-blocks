		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<input name="google_api_key_option" type="text" id="google_api_key_option" aria-describedby="tagline-description" value="<?php echo get_option('google_api_key_option'); ?>" class="regular-text">
						<p class="description" id="tagline-description">Please create your own API key on the <a href="https://console.developers.google.com" target="_blank" rel="noreferrer">Google Console </a>This is a requirement enforced by Google.</p>
					</td>
				</tr>
			</table>
			<?php submit_button(); ?>
