...
function get_palette_color($color, $block_style = 'light')
{
    if (class_exists('MaxiBlocks_StyleCards')) {
        ...
        // Check if the primary color key exists
        if (isset($sc_value[$block_style]['styleCard']['color'][$color])) {
            return $sc_value[$block_style]['styleCard']['color'][$color];
        }

        // Check if the default color key exists
        if (isset($sc_value[$block_style]['defaultStyleCard']['color'][$color])) {
            return $sc_value[$block_style]['defaultStyleCard']['color'][$color];
        }
    }
