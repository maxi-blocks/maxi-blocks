...
describe('setSVGContent', () => {
	...
	it('Return svg element with new colour fill', () => {
	...
	it('Return svg element with new colour fill when data-hover-fill attribute is in content', () => {
		expect(
	...
	it('Return svg element with new colour stroke', () => {
		expect(
	...
	it('Return svg element with modified width', () => {
		expect(setSVGContent(svgContent, '32px', 'width')).toMatchSnapshot();
	});
});
