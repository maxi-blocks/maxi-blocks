...
const motionFadeIn1 = () => {
  ...
  return (
    <SVG xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 72.75 65.25">
      ...
      <Path fill="none" stroke="#081219" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M35.22 38.15h3.57l-5-5m5 5h.29l-.25-3.57" data-name="Layer1 25 MEMBER 1 1 STROKES" />
      <Path fill="none" stroke="#ff4a17" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M64.95 7.74l.14 7.29m-.14-7.29l-8.6 9m1.49-8.84l7.11-.11" data-name="Layer1 25 MEMBER 2 1 STROKES" />
    </SVG>
  )
}
