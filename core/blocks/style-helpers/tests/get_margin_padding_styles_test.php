...
class Get_Margin_Padding_Styles_Test extends WP_UnitTestCase
{
    use MatchesSnapshots;

    public function test_get_a_correct_margin_and_padding_simple_styles()
    {
        $obj = [
        ...
        $result = get_margin_padding_styles(['obj' => $obj]);

        $this->assertMatchesJsonSnapshot(json_encode($result));
    }

    public function test_get_a_correct_margin_and_padding()
    {
        $obj = [
            'margin-top-general' => '1',
            'margin-right-general' => '2',
    ...
    public function test_different_values_depends_on_the_responsive()
    {
        $obj = [
    ...
    public function test_get_a_correct_margin_and_padding_styles_when_only_unit_on_some_breakpoint_was_changed()
    {
        $obj = [
            'margin-top-general' => '11',
    ...
    public function test_get_a_correct_margin_and_padding_styles_when_value_is_undefined_but_unit_is_defined()
    {
        $obj = [
            'margin-top-general' => '',
