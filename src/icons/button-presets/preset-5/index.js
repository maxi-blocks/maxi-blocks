	...
	return (
		...
		>
			<path
				...
				d='M1.2,28.1V6.8c0-3.1,2.6-5.7,5.7-5.7h74.5c3.1,0,5.7,2.6,5.7,5.7v21.2c0,3.1-2.6,5.7-5.7,5.7H6.9
	C3.8,33.8,1.2,31.2,1.2,28.1z'
			/>
			<G>
				<Path
					style={{ fill: '#85878C' }}
					d='M17.4,19.3c-0.1,1-0.5,1.8-1.1,2.3c-0.6,0.6-1.5,0.8-2.5,0.8c-0.7,0-1.4-0.2-1.9-0.5c-0.6-0.3-1-0.8-1.3-1.5
		...
		c0,1,0.2,1.8,0.5,2.3s0.9,0.8,1.6,0.8c0.6,0,1.1-0.1,1.4-0.4c0.3-0.3,0.5-0.8,0.6-1.4H17.4z'
				...
				<Path
					style={{ fill: '#85878C' }}
					d='M20.4,22.3h-1.5v-9.7h1.5V22.3z'
				/>
				<Path
					style={{ fill: '#85878C' }}
		...
		c0,0.2-0.1,0.4-0.2,0.6s-0.4,0.2-0.6,0.2c-0.3,0-0.5-0.1-0.6-0.2C22.1,14,22,13.9,22,13.6z M23.7,22.3h-1.5v-6.9h1.5V22.3z'
				...
				<Path
					style={{ fill: '#85878C' }}
					d='M28.2,21.2c0.4,0,0.7-0.1,1-0.3s0.4-0.5,0.4-0.8H31c0,0.4-0.2,0.8-0.4,1.2c-0.2,0.4-0.6,0.7-1,0.9
		...
		c-0.3,0.4-0.4,0.9-0.4,1.6V19c0,0.7,0.1,1.3,0.4,1.7C27.3,21,27.7,21.2,28.2,21.2z'
			...
			<Path
				...
				d='M70.7,31.7h-0.5c-7.8,0-14.2-6.4-14.2-14.2v0c0-7.8,6.4-14.2,14.2-14.2h0.5c7.8,0,14.2,6.4,14.2,14.2v0
			...
			<G id='Arrow_Down_2_'>
				<G id='Arrow_Down_5_'>
					<G>
						<Path
							style={{ fill: '#85878C' }}
							d='M76,17l-3.1-3.9c-0.3-0.3-0.7-0.4-1.1-0.1c-0.3,0.3-0.4,0.8-0.1,1.1l2,2.6l0,0h-8.9v1.5h9l-2.1,2.6
