  ...
  return (
    <Fragment>
      <MiniSizeControl
        ...
        unit={widthUnit}
        onChangeUnit={(value) =>
          onChangeValue("widthUnit", value, onChangeWidthUnit)
        }
        value={width}
      ...
      <MiniSizeControl
        ...
        unit={minWidthUnit}
        onChangeUnit={(value) =>
          onChangeValue("minWidthUnit", value, onChangeMinWidthUnit)
        }
        value={minWidth}
        onChangeValue={(value) =>
          onChangeValue("minWidth", value, onChangeMinWidth)
        }
      />
      <MiniSizeControl
        ...
        unit={maxWidthUnit}
        onChangeUnit={(value) =>
          onChangeValue("maxWidthUnit", value, onChangeMaxWidthUnit)
        }
        value={maxWidth}
        onChangeValue={(value) =>
          onChangeValue("maxWidth", value, onChangeMaxWidth)
        }
      />
      <MiniSizeControl
        ...
        unit={heightUnit}
        onChangeUnit={(value) =>
          onChangeValue("heightUnit", value, onChangeHeightUnit)
        }
        value={height}
        onChangeValue={(value) =>
          onChangeValue("height", value, onChangeHeight)
        }
      />
      <MiniSizeControl
        ...
        unit={minHeightUnit}
        onChangeUnit={(value) =>
          onChangeValue("minHeightUnit", value, onChangeMinHeightUnit)
        }
        value={minHeight}
        onChangeValue={(value) =>
          onChangeValue("minHeight", value, onChangeMinHeight)
        }
      />
      <MiniSizeControl
        ...
        unit={maxHeightUnit}
        onChangeUnit={(value) =>
          onChangeValue("maxHeightUnit", value, onChangeMaxHeightUnit)
        }
        value={maxHeight}
        onChangeValue={(value) =>
          onChangeValue("maxHeight", value, onChangeMaxHeight)
        }
      />
    </Fragment>
  );
