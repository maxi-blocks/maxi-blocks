...
class Get_Arrow_Styles_Test extends WP_UnitTestCase
{
    use MatchesSnapshots;

    public function test_get_correct_arrow_styles_with_different_responsive_stages_color_background_settings()
    {
        $object = [
            'target' => '',
            'block_style' => 'light',
        ...
        $result = get_arrow_styles($object);

        $this->assertMatchesJsonSnapshot(json_encode($result));
    }

    public function test_get_correct_arrow_hover_styles_with_background_shadow_and_border_custom_colors()
    {
        $object = [
            'target' => '',
            'is_hover' => true,
    ...
    public function test_return_empty_arrow_styles_when_arrow_status_is_off()
    {
        $object = [
            'target' => '',
            'block_style' => 'light',
    ...
    public function test_return_empty_arrow_styles_when_background_color_is_not_selected()
    {
        $object = [
            'target' => '',
            'block_style' => 'light',
    ...
    public function test_return_empty_arrow_styles_when_background_color_is_selected_and_border_is_active_but_style_is_not_solid()
    {
        $object = [
            'target' => '',
            'block_style' => 'light',
    ...
    public function test_return_empty_arrow_styles_when_background_color_is_selected_and_border_is_active_but_some_style_on_hover_is_not_solid()
    {
        $object = [
            'target' => '',
            'block_style' => 'light',
