	...
	class MaxiBlocks_Dashboard {
		...
		public function maxi_blocks_settings() {
			...
			$content .=
				...
				__(
					'To make this process easy, launch <a href="https://maxiblocks.com/go/google-maps-api-quickstart" target="_blank" rel="noreferrer">' .
						__('Google Maps API Quickstart', 'maxi-blocks') .
			...
			$description =
				...
				'</h4>';
			$description .=
				'<p>For a short time we\'re offering live chat to help troubleshoot issues during the beta plugin release. Live chat will be removed in a future update. By activating this option you agree to the GDPR terms as set out in the Crisp chat service terms.</p>';
			$description .=
				'<p><a href="https://help.crisp.chat/en/article/whats-crisp-eu-gdpr-compliance-status-nhv54c/" target="_blank"' .
				'>' .
				__('Read about Crisp GDPR terms', 'maxi-blocks') .
				'</a></p>';
			...
			$content .= $this->generate_item_header(
				'MaxiBlocks is free and open source',
				false,
			);
