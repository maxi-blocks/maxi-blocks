...
describe('getTransformStyles', () => {
	it('Get a correct transform styles', () => {
		const object = {
			...
			'transform-origin-x-xxl': 'center',
			'transform-origin-y-xxl': 'middle',
			...
			'transform-origin-x-xl': 'left',
			'transform-origin-y-xl': 'bottom',
			...
			'transform-origin-x-l': 'right',
			'transform-origin-y-l': 'bottom',
			...
			'transform-origin-x-m': 'left',
			'transform-origin-y-m': 'middle',
			...
			'transform-origin-x-xs': 'center',
			'transform-origin-y-xs': 'bottom',
		};
