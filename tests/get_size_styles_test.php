...
class Get_Size_Styles_Test extends WP_UnitTestCase
{
    use MatchesSnapshots;

    public function test_get_a_correct_size_styles()
    {
        $object = [
        ...
        $result = get_size_styles($object);

        $this->assertMatchesJsonSnapshot(json_encode($result));
    }

    public function test_get_a_correct_size_styles_with_force_aspect_ratio()
    {
        $object = [
            'size-advanced-options' => true,
            'max-width-unit-general' => 'px',
    ...
    public function test_get_a_correct_size_styles_with_width_fit_content()
    {
        $object = [
            'size-advanced-options' => true,
			'max-width-unit-general' => 'px',
    ...
    public function test_get_a_correct_size_styles_with_full_width()
    {
        $object = [
    ...
    public function test_get_a_correct_size_styles_with_full_width_2()
    {
        $object = [
            'size-advanced-options' => true,
            'full-width-general' => true,
    ...
    public function test_get_a_correct_size_styles_with_full_width_3()
    {
        $object = [
            'full-width-general' => true,
            'size-advanced-options' => true,
...
'min-height-general' => '1',
    ...
    public function test_get_a_correct_size_styles_with_full_width_responsive()
    {
        $object = [
            'full-width-general' => true,
            'size-advanced-options' => true,
    ...
    public function test_get_a_correct_size_styles_with_full_width_responsive_2()
    {
        $object = [
