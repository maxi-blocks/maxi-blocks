...
class MaxiBlocks_QuickStart {
	...
	public function render_quick_start_page() {
		$current_step = isset($_GET['step'])
			...
			: $this->get_first_step();
		$this->init_steps();
		// Initialize steps when rendering
		?>
	...
	public function quick_start_step() {
		?>
        <h1><?php _e(
        	'Welcome to the MaxiBlocks quick start',
        	'maxi-blocks',
        ); ?></h1>
        <p class="description">
            <?php _e(
	...
	public function pages_step() {
        ...
        <div class="maxi-quick-start-section">
            <h2><?php _e(
            	'Select the page layout you like',
            	'maxi-blocks',
            ); ?></h2>
            <p class="description">
                <?php _e(
        ...
        <div class="maxi-quick-start-section">
            ...
            <div class="site-icon-wrapper">
                ...
                if ($site_icon_id) {
                	...
                	echo '<p>' .
                		__('Current Site Icon:', 'maxi-blocks') .
                		'</p>';
                	echo '<img src="' .
                		esc_url($icon_url) .
