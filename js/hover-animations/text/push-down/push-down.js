jQuery(document).ready(function($) {
    $('body:not(.wp-admin) .hover-animation-text.hover-animation-type-text-push-down').each(function(){
        if(!$(this).hasClass('hover_done')){
        $(this).wrapInner('<div class="hover_el_cont"><div class="hover_el"></div></div>')
