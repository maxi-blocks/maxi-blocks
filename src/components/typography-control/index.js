			...
			<div className={classes}>
				...
				{!linkOnly && (
					<>
						...
						{showAdvancedOptions && (
							<div className='maxi-typography-control__advanced-options'>
								<AdvancedNumberControl
