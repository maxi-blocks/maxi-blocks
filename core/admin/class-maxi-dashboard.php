    ...
    class MaxiBlocks_Dashboard
    {
        ...
        public function maxi_config_page()
        {
            $settings_tabs = [
                ...
                self::$maxi_prefix . 'pro' => __('Pro library', 'maxi-blocks'),
        ...
        public function maxi_blocks_welcome()
        {
            ...
            $content .=
                '<svg class="news-maxi-svg" width="64px" height="64px" viewBox="0 0 64 64" data-stroke="" stroke="#081219" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"><path d="M55.8 16.2V9.9H15.6v6.3h40.2m-39 9.3v12.4h10.3V25.5H16.8M56 29.7H45.7v25.8H56V29.7z" data-fill="" fill="#FF4A17"></path><g fill="none"><path d="M62.1 5.6l-2.3-3.1L57.3 5l-2.6-2.5L52.1 5l-2.6-2.5L47 5l-2.5-2.5L41.8 5l-2.5-2.5L36.7 5l-2.6-2.5L31.5 5 29 2.5 26.4 5l-2.6-2.5L21.2 5l-2.6-2.5L16.1 5l-2.6-2.5-2.9 3.1v8.7 40.6c-.4 4.9-2.4 6.5-4.3 6.5.5.2 1.1.3 1.8.3h54V5.6"></path><path d="M44.7 21.5H57m-12.3 4H57M10.6 14.3H2v41.3c0 2.6 1.9 5 4.3 5.7m9.5-39.8h12.3M15.8 42.7h12.3m-12.3 4.1h12.3M15.8 51h12.3m-12.3 4.5h12.3m3.2-34H41m-9.7 4.1H41m-9.7 4.3H41m-9.7 4.2H41m-9.7 4.2H41m-9.7 4.2H41m-9.7 13H41m-9.7-8.7H41"></path><path d="M31.3 51H41"></path></g></svg>';
            $content .=
                '<p>' . __('News and stories for creators.', 'maxi-blocks');
            $content .=
                ' <a href="https://maxiblocks.com/go/read-the-blog" target="_blank">' .
            ...
            $content .=
                '<p>' .
                __('Get a summary of stories you missed.', 'maxi-blocks');
            $content .=
                ' <a href="https://maxiblocks.com/go/notify-me" target="_blank">' .
            ...
            $content .=
                '<p>' . __('Your thoughts can inspire others.', 'maxi-blocks');
            $content .=
                ' <a href="https://maxiblocks.com/go/give-a-review" target="_blank">' .
                __('Give a quick review', 'maxi-blocks') .
                '</a>.</p>';
            $content .= '</div>'; // maxi-dashboard_main-sidebar-item
        ...
        public function maxi_blocks_pro()
        {
            ...
            $user_name = $current_user->user_firstname;
            $content =
                '<div class="maxi-dashboard_main-content maxi-dashboard_main-content-pro-library">';
            $content .=
                '<div class="maxi-dashboard_main-content_accordion" id="maxi-dashboard_main-content_pro-not-pro">';

            $content .= '<div id="maxi-dashboard_main-content_not-pro">';
            $content .=
                '<h1>' .
                __(
                    'Thousands of premium templates to work faster',
                    'maxi-blocks',
                ) .
                '</h1>';
            $content .=
                '<h2>' .
                __(
                    'Unlimited downloads. Unlimited sites. No feature lock-in.',
                    'maxi-blocks',
                ) .
                '</h2>';
            $content .=
                '<p>' .
                __(
                    'Find inspiration, or add variety to your designs. Boost your productivity and grow your audience. Join our community of creators who love to build fast, beautiful, responsive websites.',
                    'maxi-blocks',
                ) .
                '</p>';
            $content .=
            ...
            $content .=
                '<a href="https://maxiblocks.com/go/pricing" target="_blank" class="sign-up_button">' .
                __('Sign up', 'maxi-blocks') .
                '</a>';
            $content .=
                '<br/><br/><br/><p>' .
                __('Already have an account? ', 'maxi-blocks');
            $content .= '</p>';
            $content .= '<p>Sign in from the template library like this.</p>';
            $content .=
                '<p>Step 1. Launch template library from the page edit screen.</p>';
            $content .=
                '<img class="maxi-dashboard-how-to-image" src="' .
                esc_url(MAXI_PLUGIN_URL_PATH) .
                'img/how-to-log-in-1.png"/>';
            $content .= '<p>Step 2. Add email and sign in.</p>';
            $content .=
                '<img class="maxi-dashboard-how-to-image" src="' .
                esc_url(MAXI_PLUGIN_URL_PATH) .
                'img/how-to-log-in-2.png"/>';
            $content .= '</div>';
            $content .= '<ul class="not_loggedin-bottom-menu">';
            $content .=
                '<li><a href="https://maxiblocks.com/go/help-desk" target="_blank">' .
                __('help desk', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href="https://maxiblocks.com/go/pro-library" target="_blank">' .
                __('pro library', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href=" https://maxiblocks.com/go/demo-library" target="_blank">' .
                __('demo library', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href="https://www.youtube.com/@maxiblocks" target="_blank">' .
                __('youtube', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href="https://maxiblocks.com" target="_blank">' .
                __('maxiblocks.com', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href="https://twitter.com/maxiblocks" target="_blank">' .
                __('twitter', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href="https://maxiblocks.com/go/maxi-discord" target="_blank">' .
                __('discord community', 'maxi-blocks') .
                '</a></li>';
            $content .=
                '<li><a href="https://maxiblocks.com/go/roadmap" target="_blank">' .
                __('roadmap', 'maxi-blocks') .
                '</a></li>';
            $content .= '</ul>';
            ...
            $content .=
                '<div id="maxi-dashboard_main-content_pro" class="maxi-dashboard_main-content-pro-library-logged-in">';
            $content .= '<h2>' . __('Hi ', 'maxi-blocks');
            $content .= '<span>' . __('[username]', 'maxi-blocks') . '</span>';
            $content .= '</h2>';
            $content .= '<h2>' . esc_html($user_name) . '</h2>';
            $content .=
                '<h1>' .
                __(
                    "You're signed in. Pro library is connected.",
                    'maxi-blocks',
                ) .
                '</h1>';
            $content .=
                '<h3>' . __('Browse for templates', 'maxi-blocks') . '</h3>';
            $content .= '<ul>';
            $content .=
                '<li>' .
                __(
 ...
 */
        private function generate_report_text($data)
        {
         ...
         */
        private function generate_server_environment_section($data)
        {
         ...
         */
        private function generate_wordpress_environment_section($data)
        {
         ...
         */
        private function generate_plugin_information_section($plugins, $mu_plugins, $active)
        {
        ...
        /**
         * Generate the status page content
         */
        public function maxi_blocks_status()
        {
            ...
            $sessenb = isset($_SESSION) ? __('Enabled', 'maxi-blocks') : __('Disabled', 'maxi-blocks');
            $usecck = ini_get('session.use_cookies') ? __('On', 'maxi-blocks') : __('Off', 'maxi-blocks');
            ...
            $ok_status = '<td class="status-ok"><span>' . __('OK', 'maxi-blocks') . '</span></td>';
            $warning_status = '<td class="status-warning"><span>' . __('Warning', 'maxi-blocks') . '</span></td>';
