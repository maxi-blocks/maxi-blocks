...
{
    private static ?MaxiBlocks_Templates_Processor $instance = null;

    public static function register(): MaxiBlocks_Templates_Processor
    {
        if (null === self::$instance) {
            self::$instance = new MaxiBlocks_Templates_Processor();
        }
