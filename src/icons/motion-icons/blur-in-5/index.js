...
const motionBlurIn5 = () => {
  ...
  return (
    <SVG id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="0 0 73.92 65.71">
      ...
      <Path id="Layer1_16_2_STROKES" data-name="Layer1 16 2 STROKES" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" stroke="#464a53" d="M46.46,27.76l-2.55-2.5v7.1m0-7.1-.2-.2-2.35,2.7" transform="translate(0.11 -0.19)" />
      ...
      <Path id="Layer1_16_MEMBER_1_1_STROKES" data-name="Layer1 16 MEMBER 1 1 STROKES" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" stroke="#ff4a17" d="M6.19,45.87,1.17,51l3.29-.11M1,47.29.89,51h.28" transform="translate(0.11 -0.19)" />
    </SVG>
  )
}
