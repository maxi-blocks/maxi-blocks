...
use GXBlocks\Layouts\Component_Registry;
 ...
 */
function gx_blocks_register_layout_component( array $data ) {
 ...
 */
function gx_blocks_get_layouts() {
	$registry = Component_Registry::instance();
 ...
 */
function gx_blocks_get_sections() {
	$registry = Component_Registry::instance();
