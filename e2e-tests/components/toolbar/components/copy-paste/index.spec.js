...
describe('CopyPaste from Toolbar', () => {
	...
	it('Should copy and paste styles with special paste', async () => {
		...
		const expectAttributes = {
			...
			'margin-bottom-g': '24',
			'margin-left-g': '24',
			'margin-top-unit-g': 'em',
			'margin-right-unit-g': 'em',
			'margin-bottom-unit-g': 'em',
			'margin-left-unit-g': 'em',
			'padding-top-g': undefined,
			'padding-right-g': undefined,
			'padding-bottom-g': undefined,
			'padding-left-g': undefined,
			'padding-top-unit-g': 'px',
			'padding-right-unit-g': 'px',
			'padding-bottom-unit-g': 'px',
