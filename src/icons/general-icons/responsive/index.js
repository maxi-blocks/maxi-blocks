...
const responsive = (
	<SVG xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'>
		...
		<Path
			fill='#FF4A17'
			d='M27.7 20.2l.1-.1c.9-.8 2-1.3 3.3-1.3-1.3 0-2.4.4-3.3 1.3l-.1.1c-.4.4-.7.8-.9 1.2-.3.6-.5 1.3-.5 2.1 0 1.3.4 2.5 1.3 3.4.4.4.9.8 1.5 1 .6.2 1.2.3 1.8.3-.7 0-1.3-.1-1.8-.3-.6-.2-1.1-.6-1.5-1-.9-.9-1.3-2.1-1.3-3.4 0-.8.2-1.5.5-2.1.2-.4.5-.8.9-1.2m14 3c0-.6-.3-.9-.9-.9h-3.2v22.5h3.2c.6 0 .9-.3.9-1v-1.4c0-.4 2.9-1.6 3.3-1.3l.8 1.1c.5.5 3-2.2 2.5-2.7l-.8-1c-.3-.4.9-3.1 1.3-3.1h1.4c.6 0 .6-3.7 0-3.7h-1.4c-.5 0-1.7-2.7-1.3-3.2l.8-.8c.5-.5-2-3.2-2.5-2.7l-.8 1c-.4.2-2.4-.4-2.4-.4l-.1-.1c-.5-.2-.8-.4-.8-.8v-1.5'
		/>
		<Path
			fill='#FF4A17'
			d='M40.8 29.2c.6.2 1.1.6 1.5 1 .9.9 1.4 2 1.4 3.4 0 1.2-.5 2.3-1.4 3.3-.4.5-.9.8-1.5 1-.5.2-1.2.3-2 .3.8 0 1.5-.1 2-.3.6-.2 1.1-.6 1.5-1 .9-1 1.4-2.1 1.4-3.3 0-1.4-.5-2.5-1.4-3.4-.4-.4-.9-.8-1.5-1-.5-.2-1.3-.4-2.2-.4 1 .1 1.7.2 2.2.4z'
		/>
		<Path
			fill='none'
			stroke='#081219'
