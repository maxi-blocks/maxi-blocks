...
describe('getOrganizedAttributes', () => {
	...
	it('Ensure getOrganizedAttributes work correctly with image copy-paste', () => {
		...
		const object = {
			...
			'text-indent-unit-general': 'px',
			'hover-type': 'none',
			'hover-preview-general': true,
			'hover-extension-general': false,
			...
			'hover-border-status-general': false,
			...
			'hover-content-typography-status-general': false,
			...
			'hover-margin-status-general': false,
			...
			'hover-padding-status-general': false,
			...
			'hover-title-typography-status-general': false,
