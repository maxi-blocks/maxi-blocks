		...
		>
			<G>
				<polyline
					...
					points='1.6,31.7 4.6,33.5 86.3,33.5 86.4,3.5 85.2,1.9 2.4,30.7 	'
				/>
				<G>
					<rect
						x='27.8'
						y='-25.1'
						transform='matrix(-1.836970e-16 1 -1 -1.836970e-16 59.9455 -26.6358)'
						style={{
							fill: '#FFFFFF',
							stroke: '#85878C',
							strokeMiterlimit: '10',
			...
			<G>
				<Path
					style={{ fill: '#85878C' }}
					d='M37.5,19.1c-0.1,1-0.4,1.7-1,2.3c-0.6,0.5-1.4,0.8-2.4,0.8c-0.7,0-1.3-0.2-1.9-0.5c-0.5-0.3-1-0.8-1.2-1.5
           ...
           v0.8c0,1,0.2,1.7,0.5,2.2c0.3,0.5,0.8,0.8,1.5,0.8c0.6,0,1.1-0.1,1.4-0.4c0.3-0.3,0.5-0.7,0.6-1.4H37.5z'
				...
				<Path
					style={{ fill: '#85878C' }}
					d='M40.3,22h-1.5v-9.5h1.5V22z'
				/>
				<Path
					style={{ fill: '#85878C' }}
					d='M42,13.6c0-0.2,0.1-0.4,0.2-0.6c0.1-0.2,0.4-0.2,0.6-0.2c0.3,0,0.5,0.1,0.6,0.2c0.1,0.2,0.2,0.3,0.2,0.6
           c0,0.2-0.1,0.4-0.2,0.6s-0.4,0.2-0.6,0.2c-0.3,0-0.5-0.1-0.6-0.2C42,14,42,13.8,42,13.6z M43.5,22H42v-6.7h1.5V22z'
				/>
				<Path
					style={{ fill: '#85878C' }}
					d='M47.8,20.9c0.4,0,0.7-0.1,0.9-0.3c0.2-0.2,0.4-0.5,0.4-0.8h1.4c0,0.4-0.1,0.8-0.4,1.2c-0.2,0.4-0.6,0.6-1,0.9
           ...
           c-0.3,0.4-0.4,0.9-0.4,1.6v0.2c0,0.7,0.1,1.3,0.4,1.6C47,20.8,47.4,20.9,47.8,20.9z'
				...
				<Path
					style={{ fill: '#85878C' }}
					d='M53.8,19.1l-0.7,0.7V22h-1.5v-9.5h1.5V18l0.5-0.6l1.8-2.1h1.8l-2.4,2.8l2.7,3.9h-1.7L53.8,19.1z'
				/>
			</G>
		</SVG>
	);
