jQuery(function($) {
        ...
        $('#accordion-section-globalBlockStyles').html('<h2 class="accordion-section-title">Global Block Styles<span class="dashicons dashicons-info showTooltip" data-title="Adjust default styles of all MaxiBlocks blocks, anywehere they are used" style="pointer-events: painted;"> </span></h2>');
        $('#accordion-section-themeOptions').html('<h2 class="accordion-section-title">Theme Options<span class="dashicons dashicons-info showTooltip" data-title="Adjust default styles of all MaxiBlocks blocks, anywehere they are used" style="pointer-events: painted;"> </span></h2>');
        /**
    ...
    function hide_presetsBlocks(selectedTheme, themePreset) {
        ...
        themePreset = themePreset === 'dark' ? 'Dark' : (themePreset === 'light' ? 'Light' : '')
    ...
    function initLeftSide() {
        let html = `<div class="sec-globalStyling active" data-left-section="globalStyling" title="Global Styling
">
    ...
    $(document).ready(function () {
        ...
        $('.customize-control-text').on('click','.heading-pop-up .apply-btn',function () {
        ...
        function customizePopUp() {
            ...
            $(document).on('click', '#sub-accordion-section-globalStyling .customize-section-back, #sub-accordion-section-test .customize-section-back', function () {
                $('#sub-accordion-panel-MaxiBlocks').find('.customize-panel-back').trigger( "click" );
            })
    ...
    $(document).on('click', '#_customize-button-reset', function (e) {
        ...
        // if (confirm('Are you sure you want to do this? All your setting with be restored back to default settings.')){
            ...
            $(`_customize-input-${presetId}`).attr('value', 'default' ).trigger('change');
