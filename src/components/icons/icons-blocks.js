  ...
  >
    <defs>
      <path
        ...
        strokeLinecap="round"
        fill="none"
        d="M12.65 7.35v.05h.05l-.05-.05-7.1-5.55.1 9.6 7-4v.1l.1-.05.1.05 6.7 4 .1.05-.1.1-6.8 3.9v8.05l6.8-4.25m-6.9-12L19.8 1.8v9.55m-7.35 4.2l-6.75-4.1-.05-.05.1 7.9 4.95 3.05-.05-4.9-2.75-1.7m8.8 1.6l-3.45 2.1"
      />
    </defs>
    <use href="#a" transform="translate(-.65 -.7)" />
  </svg>;
...
iconsBlocks.logoWhite = <svg viewBox="0 0 28 41">
      <path
        d="M-14.645-19.54l.21-.12-.21-.14v.26zm0 0l-12.89 7.46V3.21l12.92-8.07m.46-15.18v-18.17m-26.88 18.53l.07-.24-.07-.02v.26zm0 0l.19 14.68 9.4 5.84-.09-9.31-5.2-3.28m-4.22-8.17v-.12l13.25-7.57-13.42-10.85m26.48 18.66l-12.73-7.57-.14.12m.14-.12l-.14-.07-.19.09-.02.02.02-.28 13.44-10.85m-13.25 11.01h-.02l-.17.09v-.26m-13.25 7.7l-.28-18.28m.28 18.28l12.85 7.84m8.07 3.37l-6.53 4.04"
        fill="none"
        stroke="#fff"
        strokeWidth={3}
        strokeLinecap="round"
