// source: https://github.com/WordPress/gutenberg/blob/fc0917f8de3647bd2e01cdccab673efe45a37edd/packages/block-library/src/list-item/hooks/use-indent-list-item.js
	...
	return useCallback(() => {
		...
		if (!newListItem.innerBlocks?.length) {
			newListItem.innerBlocks = [
				createBlock('maxi-blocks/text-maxi', { isList: true }),
			];
		}
