...
class Get_Typography_Styles_Test extends WP_UnitTestCase
{
    use MatchesSnapshots;

    public function test_get_a_correct_typography_styles()
    {
        $obj = [
    ...
    public function test_get_a_correct_typography_styles_with_hover()
    {
        $obj = [
            'content' => 'Testing',
            'textLevel' => 'p',
        ...
        $result = get_typography_styles([
            ...
            'block_style' => 'light',
            'is_hover' => true,
            'normal_typography' => $obj,
        ]);

        $this->assertMatchesJsonSnapshot(json_encode($result));
    }

    public function test_get_a_correct_typography_styles_when_there_is_a_unit_value_set_for_xxl_and_general_has_no_value()
    {
        $obj = [
            'palette-status-general' => true,
    ...
    public function test_get_a_correct_default_typography_styles_with_disable_palette_defaults()
    {
        $obj = [
            'palette-status-general' => true,
    ...
    public function test_get_a_correct_typography_styles_with_disable_palette_defaults_and_changed_color()
    {
        $obj = [
            'palette-status-general' => true,
            'palette-sc-status-general' => false,
    ...
    public function test_get_a_correct_typography_styles_with_disable_palette_defaults_and_changed_opacity()
    {
        $obj = [
            'palette-status-general' => true,
            'palette-sc-status-general' => false,
    ...
    public function test_get_a_correct_typography_styles_with_disable_palette_defaults_and_reset_on_general_changed_on_other_bp_opacity()
    {
        $obj = [
            'palette-status-general' => true,
            'palette-sc-status-general' => false,
    ...
    public function test_get_a_correct_typography_styles_with_disable_palette_defaults_and_disabled_palette()
    {
        $obj = [
    ...
    public function test_get_a_correct_typography_styles_with_disable_palette_defaults_and_changed_color_and_opacity()
    {
        $obj = [
            'palette-status-general' => true,
            'palette-sc-status-general' => false,
