jQuery(document).ready(function($) {
    $('body:not(.wp-admin) .hover-animation-text.hover-animation-type-text-shutter-in-horizontal').each(function(){
        ...
        $(this).find('.hover_el').prepend($('<div class="hover_background hover_background_right"></div>'));
