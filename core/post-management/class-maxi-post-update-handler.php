...
require_once MAXI_PLUGIN_DIR_PATH . 'core/post-management/class-maxi-block-info.php';
require_once MAXI_PLUGIN_DIR_PATH . 'core/post-management/class-maxi-content.php';

class MaxiBlocks_PostUpdateHandler
{
    private static ?MaxiBlocks_PostUpdateHandler $instance = null;
    ...
    public static function get_instance(): MaxiBlocks_PostUpdateHandler
    {
        self::register();
