 ...
 * Component
 */
export const ImageLayerClosed = props => {
	const {
		imageOptions,
		defaultImageOptions,
		onChange,
			...
			{imageOptions.items.map((option, i) => (
				<MediaUploaderControl
					...
					onRemoveImage={() => {
						...
						imageOptions.items[selector].imageData.mediaURL = '';
						onRemoveImage();
...
export const ImageLayerOpened = props => {
	const {
		imageOptions,
		defaultImageOptions,
		onChange,
				...
				},
				{
					...
					content: (
						<Fragment>
							...
							/>
							{imageOptions.items[selector].sizeSettings.size ===
								'custom' && (
								<ImageCropControl
									mediaID={
							...
							<SelectControl
								...
								value={imageOptions.items[selector].repeat}
								options={[
									{
								...
								onChange={val => {
									imageOptions.items[selector].repeat = val;
							...
							<SelectControl
								...
								value={
									imageOptions.items[selector].positionOptions
										.position
								}
								options={[
									{
							...
							<SelectControl
								...
								value={imageOptions.items[selector].origin}
								options={[
									{
								...
								onChange={val => {
									imageOptions.items[selector].origin = val;
							...
							<SelectControl
								...
								value={imageOptions.items[selector].clip}
								options={[
									{
										label: __('Border', 'maxi-blocks'),
										value: 'border-box',
								...
								onChange={val => {
									imageOptions.items[selector].clip = val;
							...
							<SelectControl
								...
								value={imageOptions.items[selector].attachment}
								options={[
									{
