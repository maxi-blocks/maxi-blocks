...
const attributes = {
	...
	...prefixAttributesCreator({
		...
		diffValAttr: {
			[`${inputWO}_fs-g`]: '20',
			[`${inputPrefix}bo_s-g`]: 'solid',
			[`${inputPrefix}bo_w.t-g`]: 4,
			[`${inputPrefix}bo_w.r-g`]: 0,
			[`${inputPrefix}bo_w.b-g`]: 4,
			[`${inputPrefix}bo_w.l-g`]: 4,
			[`${inputPrefix}bo_w.sy-g`]: 'none',
			[`${inputWO}_p.t-g`]: '8',
			[`${inputWO}_p.r-g`]: '10',
			[`${inputWO}_p.b-g`]: '8',
			[`${inputWO}_p.l-g`]: '10',
			[`${inputWO}_p.sy-g`]: 'axis',
			[`${inputPrefix}b_am-g`]: 'color',
		},
	}),
	...
	...prefixAttributesCreator({
		...
		diffValAttr: {
			...
			[`${buttonWO}_p.b-g`]: '12',
			[`${buttonWO}_p.l-g`]: '12',
			[`${buttonPrefix}b_am-g`]: 'color',
			[`${buttonPrefix}bc_pc-g`]: 4,
		},
	}),
	pla: {
		type: 'string',
	...
	...prefixAttributesCreator({
		...
		diffValAttr: {
			...
			[`${closeIconPrefix}i_w-g`]: '25',
			[`${closeIconPrefix}i-f_pc`]: 1,
			[`${closeIconPrefix}i_spa-g`]: 0,
			[`${closeIconPrefix}i_c`]:
