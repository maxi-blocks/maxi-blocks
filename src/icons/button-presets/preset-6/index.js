	...
	return (
		...
		C2.9,34.3,0.4,31.7,0.4,28.6z'
				...
				<G>
					<Path
						style={{ fill: '#FFFFFF' }}
						d='M56.4,19.3c-0.1,1-0.5,1.8-1.1,2.3c-0.6,0.6-1.5,0.8-2.5,0.8c-0.7,0-1.4-0.2-1.9-0.5c-0.6-0.3-1-0.8-1.3-1.5
			...
			c0,1,0.2,1.8,0.5,2.3s0.9,0.8,1.6,0.8c0.6,0,1.1-0.1,1.4-0.4c0.3-0.3,0.5-0.8,0.6-1.4H56.4z'
					...
					<Path
						style={{ fill: '#FFFFFF' }}
						d='M59.3,22.3h-1.5v-9.7h1.5V22.3z'
					/>
					<Path
						style={{ fill: '#FFFFFF' }}
						d='M61,13.6c0-0.2,0.1-0.4,0.2-0.6c0.1-0.2,0.4-0.2,0.6-0.2c0.3,0,0.5,0.1,0.6,0.2c0.2,0.2,0.2,0.4,0.2,0.6
			c0,0.2-0.1,0.4-0.2,0.6s-0.4,0.2-0.6,0.2c-0.3,0-0.5-0.1-0.6-0.2C61.1,14,61,13.9,61,13.6z M62.6,22.3h-1.5v-6.9h1.5V22.3z'
					/>
					<Path
						style={{ fill: '#FFFFFF' }}
						d='M67.1,21.2c0.4,0,0.7-0.1,1-0.3s0.4-0.5,0.4-0.8h1.5c0,0.4-0.2,0.8-0.4,1.2c-0.2,0.4-0.6,0.7-1,0.9
			...
			c-0.3,0.4-0.4,0.9-0.4,1.6V19c0,0.7,0.1,1.3,0.4,1.7C66.2,21,66.6,21.2,67.1,21.2z'
					...
					<Path
						style={{ fill: '#FFFFFF' }}
						d='M73.3,19.3L72.6,20v2.2h-1.5v-9.7h1.5v5.6l0.5-0.6l1.9-2.1h1.9l-2.6,2.9l2.8,4h-1.8L73.3,19.3z'
					/>
				</G>
				<G>
					<Path
						style={{ fill: '#FFFFFF' }}
						d='M28.2,11.6c0.2,0.2,0.3,0.4,0.3,0.7v10.3c0,0.3-0.1,0.5-0.3,0.7c-0.2,0.2-0.4,0.3-0.7,0.3H13
