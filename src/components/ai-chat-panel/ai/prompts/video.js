...
const VIDEO_MODULE = `### MODULE: VIDEO INTENT MAPPING
...
const VIDEO_OUTPUT_FORMAT = `### OUTPUT FORMAT (MANDATORY)
...
const VIDEO_MAXI_PROMPT = composePrompt(
	ROLE,
	CRITICAL_RULES,
	clarifyProtocol('"add a video", "change the video style"'),
	PROTOCOL2_VARIABLE,
	'---',
	VIDEO_MODULE,
	INTERNAL_META_FLOW,
