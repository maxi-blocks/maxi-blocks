		...
		[uniqueID]: styleProcessor(
			{
				...
				...(!isList && {
					' .maxi-list-item-block__content': getTypographyObject(
						props,
						isList
					),
				...
				...(isList && {
					' .maxi-list-item-block__content': getListObject({
						...props,
						isRTL,
					}),
					' .maxi-list-item-block__content li': {
						...getTypographyObject(props),
						...getListItemObject(props),
					},
					' .maxi-list-item-block__content li:not(:first-child)': {
						...getListParagraphObject(props),
					},
					' .maxi-list-item-block__content li:hover':
						getTypographyHoverObject(props),
					' .maxi-list-item-block__content li::before':
				...
				...getCustomFormatsStyles(
					!isList
						...
						: ':hover .maxi-list-item-block__content li',
				...
				...(props['dc-status'] && {
					...getLinkStyles(
						...
						[
							'.maxi-block--has-link .maxi-list-item-block__content',
						],
						props.blockStyle
					),
				}),
