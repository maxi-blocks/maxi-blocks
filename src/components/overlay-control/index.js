            ...
            <div className='maxi-fancy-radio-control'>
                <RadioControl
                    ...
                    onChange={item => {
                        ...
                        if(item === 'color')
                            value.overlayOptions.activeColor = value.overlayOptions.color;
                        if(item === 'gradient')
                            value.overlayOptions.activeColor = value.overlayOptions.gradient;
                        onChange(JSON.stringify(value));
                    }}
                />
            </div>
            {
                (value.overlayOptions.overlay === 'gradient' || value.overlayOptions.overlay === 'color') &&
            ...
            }
            {
                value.overlayOptions.overlay === 'gradient' &&
                    <GradientControl
                        ...
                        gradientAboveBackground={value.overlayOptions.gradientAboveBackground}
