const dictionary = {
	...
	background: {
		...
		'background-image-mediaID': 'bim',
		'background-image-mediaURL': 'biu',
		'background-image-size': 'bis',
		'background-image-width': 'biw',
		'background-image-width-unit': 'biwu',
		'background-image-height': 'bih',
		'background-image-height-unit': 'bihu',
		'background-image-crop-options': 'bico',
		'background-image-repeat': 'bir',
		'background-image-position': 'bip',
		'background-image-position-width-unit': 'bipwu',
		'background-image-position-width': 'bipw',
		'background-image-position-height-unit': 'biphu',
		'background-image-position-height': 'biph',
		'background-image-origin': 'bio',
		'background-image-clip': 'bic',
		'background-image-attachment': 'bia',
		'background-image-clip-path': 'bicp',
		'background-image-parallax-status': 'bips', // status!
		'background-image-parallax-speed': 'bips',
		'background-image-parallax-direction': 'bipd',
		'background-image-parallax-alt': 'bipa',
		'background-image-parallax-alt-selector': 'bipas',
		'background-video-mediaID': 'bvm',
		'background-video-mediaURL': 'bvu',
		'background-video-startTime': 'bvs',
		'background-video-endTime': 'bve',
		'background-video-loop': 'bvl',
		'background-video-clip-path': 'bvc',
		'background-video-clip-path-status': 'bvcs',
		'background-video-fallbackID': 'bvfi',
		'background-video-fallbackURL': 'bvfu',
		'background-video-playOnMobile': 'bvpm',
		'background-video-reduce-border': 'bvrb',
		'background-gradient': 'bgr',
		'background-svg-SVGElement': 'bse',
		'background-svg-SVGData': 'bsd',
		'background-svg-top-unit': 'bstu',
	},
	backgroundActive: {},
	backgroundHover: {},
	border: {
