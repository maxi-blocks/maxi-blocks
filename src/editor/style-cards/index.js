			...
			resultItems.push({
				...
				content: (
					<Fragment>
						...
						<TypographyControl
							typography={getTypographyGroup(`h${item}`)}
							prefix={`h${item}-`}
							disableFormats
							...
							styleCards
							onChange={obj => {
								const parsedTypography = parseSCtypography(obj);
								onChangeValue(
									'typography',
									parsedTypography,
									SCStyle
