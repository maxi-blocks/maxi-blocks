...
class Scripts extends Component {
  ...
  render() {
  	...
  	let path_to_script = `/wp-content/plugins/maxi-blocks/js/hover-animations/${hover_animation_type}/${hover_animation}/${hover_animation}.js`;
  	let path_to_css = `/wp-content/plugins/maxi-blocks/js/hover-animations/${hover_animation_type}/${hover_animation}/${hover_animation}.css`;
