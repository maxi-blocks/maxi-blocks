/**
 * Disabled ESLint rules => needs some fixes
 */
 ...
 * Resolves the font source loading from Gutenberg blocks on backend and frontend
 */
export default class FontFamilyResolver {
	constructor() {
...
document.onreadystatechange = () => {
	document.readyState === 'complete' && new FontFamilyResolver();
};
