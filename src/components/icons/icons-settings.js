...
iconsSettings.reset = (
  <svg data-name="Layer 1" viewBox="0 0 16 15.7">
      <path
        d="M16 1v5a.91.91 0 01-.3.7.91.91 0 01-.7.3H9.9a.91.91 0 01-.7-.3 1 1 0 010-1.4.91.91 0 01.7-.3h2.6a8.09 8.09 0 00-2-2.1 4.46 4.46 0 00-2.6-.8 5.66 5.66 0 00-4.1 1.7 5.3 5.3 0 00-1.7 4.1A5.66 5.66 0 003.8 12a5.66 5.66 0 004.1 1.7 5.75 5.75 0 003.4-1.1 5.63 5.63 0 002.1-2.9 1 1 0 01.5-.6 1.41 1.41 0 01.9-.1 1 1 0 01.6.5 1.06 1.06 0 01.1.8 7.49 7.49 0 01-2.9 3.9A7.67 7.67 0 018 15.7a7.7 7.7 0 01-5.6-2.3A7.56 7.56 0 010 7.9a7.87 7.87 0 012.3-5.6A7.7 7.7 0 017.9 0a3.08 3.08 0 011 .1c.3 0 .6.1.9.1a1.33 1.33 0 01.8.3 3.63 3.63 0 00.7.3 2.09 2.09 0 01.6.4c.2.2.4.3.5.4l.5.5c.2.2.3.4.4.4s.2.2.4.5a3 3 0 00.3.4V1a.91.91 0 01.3-.7 1 1 0 011.4 0 .91.91 0 01.3.7z"
        fill="#464a53"
      />
  </svg>
);
