...
const accordion = (
    <SVG version="1.1" id="ga_layer_accordion" x="0px" y="0px"
        ...
        <g transform="matrix( 1, 0, 0, 1, -0.05,-1.9) ">
            <g>
                <Path id="gx_accordion_STROKES" className="st0" d="M20.3,5.1v1h1 M20.3,6.1v1 M21.3,21.7h-1v1 M21.3,17.5h-1v1 M20.3,16.5v1h-1
