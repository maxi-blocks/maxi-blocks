...
describe('getTransformStyles', () => {
	it('Get a correct alignment', () => {
		const object = {
			...
			'transform-translate-x-unit-general': 'test',
			'transform-translate-x-general': 3,
			'transform-translate-y-unit-general': 'test',
			...
			'transform-translate-x-unit-xxl': 'test',
			'transform-translate-x-xxl': 2,
			'transform-translate-y-unit-xxl': 'test',
			...
			'transform-translate-x-unit-xl': 'test',
			'transform-translate-x-xl': 1,
			'transform-translate-y-unit-xl': 'test',
			...
			'transform-translate-x-unit-l': 'test',
			'transform-translate-x-l': 4,
			'transform-translate-y-unit-l': 'test',
			...
			'transform-translate-x-unit-m': 'test',
			'transform-translate-x-m': 3,
			'transform-translate-y-unit-m': 'test',
			...
			'transform-translate-x-unit-s': 'test',
			'transform-translate-x-s': 2,
			'transform-translate-y-unit-s': 'test',
			...
			'transform-translate-x-unit-xs': 'test',
			'transform-translate-x-xs': 1,
			'transform-translate-y-unit-xs': 'test',
