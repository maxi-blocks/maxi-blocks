...
export const preset7 = {
	...
	'icon-width-xxl': '35',
	'icon-stroke-xxl': 1.5,
	'button-padding-top-xxl': undefined,
	'button-padding-right-xxl': undefined,
	'button-padding-bottom-xxl': undefined,
	'button-padding-left-xxl': undefined,
	'icon-padding-bottom-xxl': undefined,
	'icon-padding-left-xxl': undefined,
	'icon-padding-right-xxl': undefined,
	'icon-padding-top-xxl': undefined,
...
export const preset9 = {
	...
	'typography-status-hover': false,
	'icon-status-hover': true,
	'icon-background-active-media-general-hover': 'color',
	'icon-border-style-general-hover': 'none',
	'icon-background-palette-status-general-hover': true,
	'icon-background-palette-color-general-hover': 6,
	'icon-border-palette-status-general-hover': false,
	'icon-stroke-palette-status-hover': true,
	'icon-stroke-palette-color-hover': 1,
};
