...
const attributes = {
	...
	...prefixAttributesCreator({
		...
		diffValAttr: {
			...
			[`${prefix}padding-sync-general`]: undefined,
			[`${prefix}padding-top-general`]: undefined,
			[`${prefix}padding-right-general`]: undefined,
			[`${prefix}padding-bottom-general`]: undefined,
			[`${prefix}padding-left-general`]: undefined,
		},
	}),
