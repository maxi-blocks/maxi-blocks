...
const motionFadeOut3 = () => {
    ...
    return (
      <SVG xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 72.75 65.25">
        ...
        <Path fill="none" stroke="#081219" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M35.25 22.74h3.57l-5-5m5 5h.28l-.25-3.57" data-name="Layer1 22 MEMBER 1 1 STROKES"/>
        <Path fill="none" stroke="#ff4a17" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M65.19 48.12l.14-7.28m-.14 7.28l-8.59-8.95m1.49 8.84l7.1.11" data-name="Layer1 22 MEMBER 2 1 STROKES"/>
      </SVG>
    )
}
